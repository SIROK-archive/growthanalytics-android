...
import com.growthbeat.analytics.GrowthAnalyticsException;
...
public class GrowthAnalyticsHttpClient extends BaseHttpClient {

	public GrowthAnalyticsHttpClient() {
		super();
	}
	...
	protected JSONObject request(String method, String api, Map<String, Object> params) {
		...
		try {
			...
			throw new GrowthAnalyticsException("Failed to encode request body.", e);
		}
